...
namespace LAB13_ATOMS
{
    ...
    internal class Program
    {
        ...
        static void ReadJson(string filename)
        {
           TextReader reader = new StreamReader(filename);
            List<Atom> elementsDesrilized = JsonSerializer.Deserialize<List<Atom>> (reader.ReadToEnd);
            foreach (Atom element in elementsDesrilized)
            {
  ...
  elements.Add(Atom.Parse("Meitnerium 109 159 268 Mt"));
        ...
        static void Main(string[] args)
        {
            ...
            WriteJson(elements, "D:\\College\\COMP123 - C#\\Class Labs\\Week1 Lab1\\LAB13_ATOMS\\AllElements.json");
            ReadJson("D:\\College\\COMP123 - C#\\Class Labs\\Week1 Lab1\\LAB13_ATOMS\\AllElements.json");
        }
    }
}
